...
let movies = [
  ...
  },
  {
    ...
    rating: 'R',
    imageURL:
      'https://www.imdb.com/title/tt0112573/mediaviewer/rm3170786816/?ref_=tt_ov_i',
    featured: true,
  },
  {
    title: 'Midway',
    description:
      'The film, based on the real-life events of this heroic feat, tells the story of the leaders and soldiers who used their instincts, fortitude and bravery to overcome the odds. In May 1942 the Imperial Japanese Navy launches an attack on the island of Midway in the Pacific Ocean.',
    genre: {
      name: 'Action',
      description:
    ...
    rating: 'PG-13',
    imageURL:
      'https://www.imdb.com/title/tt6924650/mediaviewer/rm3946167041/?ref_=tt_ov_i',
    featured: true,
  },
  {
    title: 'Hangover',
    ...
    rating: 'R',
    imageURL:
      'https://www.imdb.com/title/tt1119646/mediaviewer/rm401570304/?ref_=tt_ov_i',
    featured: true,
  },
  {
  ...
  },
  {
    ...
    description:
      'Young F.B.I. trainee Clarice Starling (Jodie Foster) is assigned to help find a missing woman to save her from a psychopathic serial killer (Ted Levine) who skins his victims. Clarice attempts to gain a better insight into the twisted mind of the killer by talking to another psychopath: Dr.',
    genre: {
      name: 'Thriller',
      description:
